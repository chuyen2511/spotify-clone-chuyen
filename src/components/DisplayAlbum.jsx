    ...
    <>
      ...
      <div className=' mt-10 flex gap-8 flex-col md:flex-row md:items-end'>
        ...
        <p>Playlist</p>
          ...
          <p className='mt-1'>
            <img className=' inline-block w-6' src={assets.spotify_logo}/>
            <b className='ml-1'>Spotify</b>
            <span className='ml-1'>1,232,154 like</span>
            <b className='ml-1'>50 song</b>
            <span className='ml-1'>about 2hr 30 min</span>
